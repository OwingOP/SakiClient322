...
public final class CheckBox extends RenderableSetting {
  ...
  public void render(class_332 context, int mouseX, int mouseY, float delta) {
    ...
    TextRenderer.drawString(chars, context, nameOffset, parentY() + parentOffset() + this.offset + 9, (new Color(245, 245, 245, 255)).getRGB());
    context.method_25296(parentX() + 5, parentY() + parentOffset() + this.offset + 5, parentX() + 25, parentY() + parentOffset() + this.offset + parentHeight() - 5, Utils.getMainColor(255, this.parent.settings.indexOf(this)).getRGB(), Utils.getMainColor(255, this.parent.settings.indexOf(this) + 1).getRGB());
    context.method_25294(parentX() + 7, parentY() + parentOffset() + this.offset + 7, parentX() + 23, parentY() + parentOffset() + this.offset + parentHeight() - 7, Color.darkGray.getRGB());
    context.method_25296(parentX() + 9, parentY() + parentOffset() + this.offset + 9, parentX() + 21, parentY() + parentOffset() + this.offset + parentHeight() - 9, this.setting.getValue() ? Utils.getMainColor(255, this.parent.settings.indexOf(this)).getRGB() : Color.darkGray.getRGB(), this.setting.getValue() ? Utils.getMainColor(255, this.parent.settings.indexOf(this) + 1).getRGB() : Color.darkGray.getRGB());
