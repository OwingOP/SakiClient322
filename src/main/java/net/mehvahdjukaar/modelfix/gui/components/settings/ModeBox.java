...
public final class ModeBox extends RenderableSetting {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        TextRenderer.drawString(this.setting.getName() + ": ", context, nameOffset, parentY() + parentOffset() + this.offset + 9, new Color(245, 245, 245, 255).getRGB());
        nameOffset += TextRenderer.getWidth(this.setting.getName() + ": ");
